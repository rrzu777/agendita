...
La navegación móvil se comprobó además en Brave producción a 390 px: todas las secciones estaban accesibles, pero el autofocus del drawer elegía Cerrar sesión. Una regresión E2E reprodujo el fallo en local y luego pasó (1/1, sin reintentos): el menú enfoca su título al abrir, no enfoca logout, y Escape restaura el botón Más. No se alteraron destinos, permisos, guard de borradores ni acciones de sesión.
