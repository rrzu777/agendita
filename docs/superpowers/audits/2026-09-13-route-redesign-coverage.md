...
| 26–27 Admin | Zero-state/lista, conteo de atención y salud de cuenta cubiertos por page tests. Pruebas enfocadas de los controles reales cubren apertura/cancelación/foco, contrato `min-h-11` y fallos/pending representativos de suspensión y configuración; no prueban cada acción administrativa ni proveedor real. | Lista/detalle en los tres tamaños; se corrigió overflow por min-content a 390 px. Las cuatro acciones de los diálogos admin midieron 44 px reales a 390/834/1440 tras estabilizar la animación; ninguno se confirmó. |
