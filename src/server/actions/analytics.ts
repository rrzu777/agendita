...
const linkSchema = z.strictObject({
  ...
  // Plain campaign label, not contact information. This does not claim universal PII detection.
  campaignName: z.string().trim().min(1).max(80).refine((value) => !/[<>@\p{Cc}]|https?:\/\/|\d{8,}/u.test(value)),
