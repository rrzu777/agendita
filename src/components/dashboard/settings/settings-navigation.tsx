...
export function SettingsNavigation() {
  ...
  const currentSection = SETTINGS_SECTIONS.find((section) => section.href === pathname)?.key ?? 'profile'
          ...
          return (
            <li key={section.key}>
              <GuardedLink
                ...
                className={cn(
                  'flex min-h-11 items-center border-b-2 px-3 text-sm font-medium whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 lg:w-full lg:border-b-0 lg:border-l-2 lg:px-4',
                  isCurrent
