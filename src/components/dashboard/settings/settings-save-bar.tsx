...
function getStatusMessage({ isDirty, isSubmitting, status, error }: SettingsSaveBarProps) {
  ...
  return isDirty ? 'Cambios sin guardar' : 'Sin cambios pendientes'
}
...
export function SettingsSaveBar(props: SettingsSaveBarProps) {
  ...
  return (
    <div className="sticky bottom-[calc(4.5rem+env(safe-area-inset-bottom))] z-30 -mx-5 mt-8 border-y border-border/60 bg-card/95 px-5 py-3 backdrop-blur md:bottom-0 md:-mx-10 md:px-10">
