      ...
      <main className="studio-shell flex items-center justify-center px-4 py-12">
        <Card className="studio-card w-full max-w-md px-4 py-6 sm:px-8">
          <CardHeader className="text-center">
            ...
            <CardTitle className="font-heading text-3xl font-semibold tracking-tight text-primary">Verifica tu email</CardTitle>
            <CardDescription>
    ...
    <main className="studio-shell flex items-center justify-center px-4 py-12">
      ...
      <Card className="studio-card w-full px-4 py-6 sm:px-8">
        <CardHeader className="px-0 text-left">
          ...
          <CardTitle className="font-heading text-4xl font-semibold tracking-tight text-primary">Crea tu cuenta</CardTitle>
