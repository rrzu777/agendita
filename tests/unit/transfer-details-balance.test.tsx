...
describe('TransferDetails variante saldo', () => {
  it('default sigue diciendo abono', () => {
    const html = renderToStaticMarkup(
      <TransferDetails bank={bank} amount={8000} currency="CLP" deadlinePhrase={null} declaring={false} onDeclare={() => {}} bookingId="b1" />,
    )
  ...
  it('variante saldo dice saldo y no muestra plazo', () => {
    const html = renderToStaticMarkup(
      <TransferDetails bank={bank} amount={8000} currency="CLP" deadlinePhrase={null} declaring={false} onDeclare={() => {}} bookingId="b1" kind="balance" />,
    )
