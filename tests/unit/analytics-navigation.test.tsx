...
describe('profile acquisition navigation contracts', () => {
  it('path-based profile carries acquisition and referral in the booking CTA and login alias', async () => {
    ...
    expect(page.props.eligible).toBe(false)
    expect(page.props.children.props.bookingHref).toBe('/book/salon?ref=74d2b4a1-c53a-41d5-a145-5318f1d2d382&acq=abcdefghijklmnopqrstuv')
    expect(decodeURIComponent(page.props.children.props.accountCta.href)).toContain('/ir/salon?ref=74d2b4a1-c53a-41d5-a145-5318f1d2d382&acq=abcdefghijklmnopqrstuv')
  })
