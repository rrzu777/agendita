...
describe('StepConfirmation booking number', () => {
  it('renders #<number> when present', () => {
    const html = renderToStaticMarkup(
      <StepConfirmation timezone="America/Santiago" data={data} bookingId="clabc12345" bookingNumber={4738} mode="paid" promo={null} sessionEmail={null} />,
    )
  ...
  it('falls back to the cuid slice when number is null', () => {
    const html = renderToStaticMarkup(
      <StepConfirmation timezone="America/Santiago" data={data} bookingId="clabc12345" bookingNumber={null} mode="paid" promo={null} sessionEmail={null} />,
    )
